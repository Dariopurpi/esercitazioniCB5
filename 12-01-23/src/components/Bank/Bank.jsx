...
const Bank = () => {
  ...
  if (loading) return <h1 className="loading">Caricamento in corso...</h1>;

  if (error)
    return <div className="error">Errore. Prova a ricaricare la pagina...</div>;
        ...
        <div className="cardBank">
          ...
          <div className="infoNumber">
            <div className="headAccountNumber">
              ...
              <span className="fetch_account_number">
                {data?.account_number}
              </span>
            </div>
            ...
            <div className="headRoutingNumber">
              ...
              <span className="fetch_routing_number">
                {data?.routing_number}
              </span>
            </div>
